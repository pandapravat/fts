...
<div>
	<div class='logo'><img alt="TCS Logo" class="logoImg" src="../images/tcs-logo.jpg" title="TCS logo"></div>
	...
	<c:if test="${not empty cubeId }">
			<div id="affectedCube"><c:out value="${cubeId }"></c:out></div>
	</c:if>
		<div id="message"><c:out value="${message }"></c:out>
		</div>
	</c:if>
	<div id="credits">
	...
	<div class="asyncView" id="updateFormHolder">
			<div id="title" class="asyncViewContents">Update Associate Details
				<img src="../images/close.jpg" title="Close screen" alt="close" width="15px" height="15px" style="float: right;" class="closeView">
			</div>
			<div id="contents">
				<div style="width:10%; margin:auto; margin-top:30px; margin-bottom:30px;">
					<img src="../images/loading.gif" title="loading.." alt="loading Data"  >
				</div>
			</div>
	</div>
	<div class="asyncView" id="addFormHolder">
			<div id="title" class="asyncViewContents">Add Associate Details
				<img src="../images/close.jpg" title="Close screen" alt="close" width="15px" height="15px" style="float: right;" class="closeView">
			</div>
			<div id="contents">
				<div style="width:10%; margin:auto; margin-top:30px; margin-bottom:30px;">
