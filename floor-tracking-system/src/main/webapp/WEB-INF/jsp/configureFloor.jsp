...
<body>
			...
			<div id="configureStep1" class="center divTable">
				...
				<div class="divRow">
					<div class="divCol">
						...
						<div class="right">
							<form:input path="establishmentName" />
						</div>
					</div>
				</div>
				<div class="divRow">
				...
				<c:if test="${step == 1 }">
					<div class="divRow">
						<div class="divCol" style="margin-top: 30px;">
							...
							<div class="right">
								<input type="button" class="g-button" value="Back"
									onclick="location.replace('./chooseFloor.ats')" />
							</div>
						</div>
					</div>
				</c:if>
	...
	<c:if test="${step eq 2 }">
		<div id="configureStep2">
			<form:form action="./configureNewFloor.ats?step=3"
				commandName="odcVo" id="confStep2">
				<div id="configureStep1" class="center divTable">
					<div class="tableTitle">Provide Floor Details</div>
					<div class="divRow">
						<div class="divCol">
							<div class="left">ODC Name (*)</div>
							<div class="right">
								<form:input path="odcName" readonly="true" />
							</div>
						</div>
					</div>
					<div class="divRow">
						<div class="divCol">
							<div class="left">Floor (*)</div>
							<div class="right">
								<form:input path="floorNumber" readonly="true" />
							</div>
						</div>
					</div>
					<div class="divRow">
					...
					<div class="divRow">
						<div class="divCol">
							<div class="left">Establishment Name (*)</div>
							<div class="right">
								<form:input path="establishmentName" readonly="true" />
							</div>
						</div>
					</div>
					<div class="divRow">
					...
					<div class="divRow">
						<div class="divCol">
							<div class="left">Rows (*)</div>
							<div class="right">
								<form:input path="rows" readonly="true" />
							</div>
						</div>
					</div>
					<div class="divRow">
						<div class="divCol">
							<div class="left">Columns (*)</div>
							<div class="right">
								<form:input path="columns" readonly="true" />
							</div>
						</div>
					</div>
					<div class="divRow">
						<div class="divCol">
							<div class="left">Floor ID (*)</div>
							<div class="right">
								<form:input path="odcId" readonly="true" />
							</div>
						</div>
					</div>
				</div>
				<div id="floorplan" class="hz-scroll-outer" style="margin-top: 30px">
					<div class="hz-scroll-inner">
						<c:forEach var="aRow" items="${odcVo.floorLayout.rowLayout}"
							varStatus="rowCnt">
							<div class="row">
								<c:forEach var="aCol" items="${aRow.rowData}"
									varStatus="colCount">
									<div class="squarecube border1">
										<c:forEach var="aCube" items="${aCol.cubes}" varStatus="stat">
											...
											<li><form:input cssClass="cubeBtn"
													path="floorLayout.rowLayout[${rowCnt.count-1 }].rowData[${colCount.count-1 }].cubes[${stat.count-1 }].cubeId"
													style="width : 50px; HEIGHT:50PX"></form:input> <form:checkbox
													cssClass="splInd"
													path="floorLayout.rowLayout[${rowCnt.count-1 }].rowData[${colCount.count-1 }].cubes[${stat.count-1 }].special"></form:checkbox></li>
				...
				<div>
					<input type="submit" id="doneBtn" value="Submit" /> <input
						class="g-button" type="button" id="prvBtn" value="Preview" /> <input
						class="g-button" type="button" id="backButton"
						value="Back To Previous" />
				</div>
			</form:form>
			<div id="previewPane"></div>
			<div>
				<input class="g-button" type="button" id="prvBack" value="Back" />
			</div>
		</div>
	</c:if>
