...
<%@page import="com.pravatpanda.apps.ats.bi.AtsException"%>
...
%>
	<div class="errortitle">an error occurred</div>
	...
	<div
		style="background-color: blue; color: #fff; font-weight: bold; cursor: pointer; width: 3em; text-decoration: underline;"
		onclick="javascript:window.history.back()">Back</div>
</body>
</html>